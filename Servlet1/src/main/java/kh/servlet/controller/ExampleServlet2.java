...
/* 자바 파일이 여러 파일 , form 연결이 다수일 경우 / 위치로 연결 */
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 ...
		 HttpServletRequest
		  ...
		  - 요청시 전달된 데이터, 요청할 클라이언트 정보, 요청을 유연하게 처리하기 위한 객체 등을 제공
		...
		//		-->  고객들이 작성된 값을 getParameter에서 name에 지정된 별칭으로 가져오기
